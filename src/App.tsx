...
const FEATURES = [
  { icon: Bot,          color: 'text-violet-400',  bg: 'from-violet-500/10 to-violet-500/[0.03]',  border: 'border-violet-500/15',  title: 'AI Training',        desc: 'We check if your content — photos, messages, or posts — can be used to train AI systems. Often hidden under phrases like "improving our services".' },
  { icon: ShoppingCart, color: 'text-rose-400',    bg: 'from-rose-500/10 to-rose-500/[0.03]',      border: 'border-rose-500/15',    title: 'Data Sharing',       desc: 'We flag if your personal data — name, email, or browsing habits — is sold or shared with advertisers and data brokers.' },
  { icon: Eye,          color: 'text-sky-400',     bg: 'from-sky-500/10 to-sky-500/[0.03]',        border: 'border-sky-500/15',     title: 'Policy Clarity',     desc: 'We assess whether the policy is written in plain, accessible language — or buried in legal complexity that most people would give up reading.' },
  { icon: Clock,        color: 'text-amber-400',   bg: 'from-amber-500/10 to-amber-500/[0.03]',    border: 'border-amber-500/15',   title: 'Data Retention',     desc: 'We check how long your data is kept after you close your account. Many platforms hold on to it for months or even years.' },
  { icon: FileText,     color: 'text-emerald-400', bg: 'from-emerald-500/10 to-emerald-500/[0.03]',border: 'border-emerald-500/15', title: 'Content Ownership',  desc: 'We verify whether you keep full rights to what you create and upload, or whether the platform claims a broad, permanent licence to use it.' },
  { icon: Lock,         color: 'text-rose-400',    bg: 'from-rose-500/10 to-rose-500/[0.03]',      border: 'border-rose-500/15',    title: 'Unfair Clauses',     desc: 'We surface forced arbitration, waived legal rights, silent auto-renewals, and opt-outs that are intentionally difficult to find.' },
];
